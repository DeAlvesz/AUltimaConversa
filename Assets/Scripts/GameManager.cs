...
public class GameManager : MonoBehaviour
{
    ...
    public Image fotoMaria2;
    public Image fotoMae;
    public TMP_Text nomeContato;
    ...
    void Start()
    {
        AudioClip musicasDeFundoComeco = musicasDeFundo[0];
        musicAudioSource.clip = musicasDeFundoComeco;
    ...
    public IEnumerator chat1()
    {
        ...
        setButtonOptionsAndShow(
            ...
            "Simm, to visitando minha cidadezinha", () => StartCoroutine(chat4())
        );
    }
    ...
    public IEnumerator chat5()
    {
        ...
        setButtonOptionsAndShow(
           ...
           "O quanto ja me ralei andando de bicicleta...", () => StartCoroutine(chat10())
         );
    }
    ...
    public IEnumerator chat17()
    {
        ...
        yield return createNewMessageFromYou("E vc, como tá seu no curso?");
    ...
    public IEnumerator chat33()
    {
        ...
        yield return createNewMessageFromMe("Nos vemos na sexta", false, 0.000000001f,   2.5f);
    ...
    public IEnumerator chat34()
    {
        ...
        yield return createNewMessageFromMe("Até sexta", false, 0.000000001f,   2.5f);
    ...
    public IEnumerator chat35()
    {
        ...
        yield return createNewMessageFromMe("Boa noite!!", false, 0.000000001f,   2.5f);
    ...
    public IEnumerator chat40()
    {
      ...
      "DESATIVADO", () => StartCoroutine(chat45())
      );
    }
    ...
    public IEnumerator chat42()
    {
        ...
        setButtonOptionsAndShow(
      "DESATIVADO", () => StartCoroutine(chat43()),
      "Certo certo, então eu lembro", () => StartCoroutine(chat44()),
      "Aé vdd, lembrei agora", () => StartCoroutine(chat45())
      );
    }
    ...
    public IEnumerator chat65()
    {
        ...
        yield return createNewMessageFromMe("Ué pq não pode?",true, 0.000000001f,   2.7f); //apaga
        yield return createNewMessageFromMe("16:00 então?",false, 1.4f,   1.4f); // reescreve com esse texto
    ...
    public IEnumerator chat66()
    {
        ...
        yield return createNewMessageFromMe("Mais cedo que 17:00? kk",true, 00000000001f, 2.7f); //apaga
        yield return createNewMessageFromMe("16:00 então?",false, 1.4f,   1.4f); // reescreve com esse texto
        yield return createNewMessageFromYou("Acho que esse horário fica massa");
        yield return createNewMessageFromYou("Lá pelas 16:00 chego ai então");
        yield return createNewMessageFromYou("Fica esperto ein😠");
    ...
    public IEnumerator chat68()
    {
        ...
        yield return createNewMessageFromMe("Resenha demais nosso papo", false, 0.000000001f,   3.2f);
    ...
    public IEnumerator chat69()
    {
        ...
        yield return createNewMessageFromMe("Meu aquele teres tava muito bom", false, 0.000000001f,   3.2f);
    ...
    public IEnumerator chat70()
    {
        ...
        yield return createNewMessageFromMe("A mãe adorou conversar contigo ein🥺", false, 0.000000001f,   3.2f);
    ...
    public IEnumerator chat715()
    {
        ...
        AudioClip musicasDeFundoComeco = musicasDeFundo[1];
        musicAudioSource.clip = musicasDeFundoComeco;
        musicAudioSource.Play();
    ...
    public IEnumerator chat71()
    {
        ...
        yield return createNewMessageFromMe("Ta tudo certo?", false, 0.000000001f,   3.2f);
    ...
    public IEnumerator chat72()
    {
        ...
        yield return createNewMessageFromMe("Ta viva? kkkj", false, 0.000000001f,   3.2f);
    ...
    public IEnumerator chat73()
    {
        ...
        yield return createNewMessageFromMe("Aloou", false, 0.000000001f,   3.2f);
    ...
    public IEnumerator chat75()
    {
      ...
      "to bem sim", () => StartCoroutine(chat77()),
      "Ah, fiquei meio preocupado", () => StartCoroutine(chat78())
      );
    }
    ...
    public IEnumerator chat87()
    {
     ...
     "Eai de boas?", () => StartCoroutine(chat89()),
    ...
    public IEnumerator chat88()
    {
        ...
        yield return createNewMessageFromMe("Ta afim de sair de novo antes de eu ir?");
    ...
    public IEnumerator chat106()//Ultima conversa
    {
        ...
        fotoMaria2.gameObject.SetActive(false);
        fotoMae.gameObject.SetActive(true);
        nomeContato.text = "Mãe";
    ...
    /*
    public IEnumerator noticia()//Ultima conversa
    {
        SceneManager.LoadScene("noticia");
    }
    */
